...
from SonaliChat.mongo.readable_time import get_readable_time
from SonaliChat.mongo.afkdb import add_afk, is_afk, remove_afk
import random 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup

NEXIO = [
        [
            InlineKeyboardButton(text="• ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ •", url=f"https://t.me/SonaliSonaliChat?startgroup=true"),
        ],
        ]
